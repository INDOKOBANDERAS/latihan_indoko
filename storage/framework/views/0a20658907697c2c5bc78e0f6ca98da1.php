<nav class="bg-[#001f3f] sticky top-0 z-50 shadow-xl border-b border-blue-900/30">
    <div class="container mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <div class="flex items-center space-x-8">
            ...
            <a href="<?php echo e(route('profile')); ?>" class="text-sm font-semibold text-blue-100 hover:text-cyan-400 transition-colors duration-300">
                Profil
            </a>
...
</nav><?php /**PATH D:\Praktikum 2026\latihan_indoko\resources\views/partials/header.blade.php ENDPATH**/ ?>