    ...
    <main class="flex-grow flex items-center justify-center px-6">
        <div class="max-w-2xl text-center">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                <a href="<?php echo e(route('profile')); ?>" class="w-full sm:w-auto bg-[#001f3f] text-white px-10 py-4 rounded-2xl font-bold shadow-2xl shadow-blue-200 hover:bg-blue-800 transition-all transform hover:-translate-y-1">
...
</html><?php /**PATH D:\Praktikum 2026\latihan_indoko\resources\views/welcome.blade.php ENDPATH**/ ?>