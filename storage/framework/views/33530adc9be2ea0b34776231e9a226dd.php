            ...
            <div class="glass-card rounded-[2.5rem] p-8 md:p-12 shadow-xl shadow-blue-900/5 flex flex-col md:flex-row items-center gap-10 mb-12">
                <div class="relative group">
                    ...
                    <div class="relative w-48 h-48 md:w-56 md:h-56">
                        <img src="<?php echo e(asset('img/profil.jpeg')); ?>" 
                             alt="Profile Indoko" 
                ...
                <div class="md:col-span-1 space-y-8">
                    <div class="glass-card p-8 rounded-[2rem] shadow-lg shadow-blue-900/5">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <?php $__currentLoopData = ['Laravel', 'PHP', 'Tailwind', 'MySQL', 'Git', 'JS']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <span class="px-3 py-1 bg-[#001f3f] text-white text-[10px] font-bold rounded-lg"><?php echo e($skill); ?></span>
